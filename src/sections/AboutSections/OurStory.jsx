                        ...
                        <div className='absolute z-10 top-10 left-10 right-10 flex-col text-2xl sm:text-5xl text-white'>
                            ...
                            <div className='flex items-center justify-center'> 
                                <div className='mt-5 text-center text-xl sm:w-2/3 w-full p-2 h-[200px] sm:h-[300px] overflow-y-auto py-2'>
                                    ...
                                    <p>As we navigated the complexities of the botanical world, we encountered challenges along the way—logistical hurdles, regulatory requirements, and the lack of product quality. Fueled by our shared passion and unwavering dedication, we persisted, overcoming obstacles with resilience and creativity.</p>
