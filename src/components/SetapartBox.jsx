  ...
  return (
    <div className="sm:px-14 px-4 grid xl:grid-cols-3 grid-cols-1 gap-5">
      <div className='flex flex-col mt-5 justify-center items-center border-4 border-[#290c06] rounded-lg'>
        <div className='w-full h-1/3 text-4xl flex flex-col font-semibold text-center justify-center p-5 bg-[#5ACEA1]'>Explore Our Research</div>
        <div className='w-full h-2/3 p-5 items-center bg-[#fff]'>
      ...
      <div className="flex flex-col mt-5 justify-center items-center border-4 border-[#290c06] rounded-lg">
        <div className="w-full h-1/3 text-4xl flex flex-col font-semibold text-center justify-center p-5 bg-[#5ACEA1]">Discover Our Creations</div>
        <div className="w-full h-2/3 p-5 items-center bg-[#fff]">
      ...
      <div className="flex flex-col mt-5 justify-center items-center border-4 border-[#290c06] rounded-lg">
        <div className="w-full h-1/3 text-4xl flex flex-col font-semibold text-center justify-center p-5 bg-[#5ACEA1]">Partner With Us</div>
        <div className="w-full sm:h-2/3 h-auto p-5 items-center bg-[#fff]">
